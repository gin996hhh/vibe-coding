...
(function () {
  ...
  var PLAN = [
    [0, 3, 3, 3, 1, true,  2, false, null, '', null, ''],
    [1, 4, 4, 4, 2, true,  2, true,  4, '睡前把手机放到客厅，连着做到了第 3 天', 4, '不想动但还是把手机拿过去了'],
    [2, 3, 2, 3, 1, true,  1, false, 3, '早上在窗边站了两分钟，比昨天早了一点', 3, ''],
    [3, 2, 2, 2, 0, true,  0, true,  2, '昨晚没睡好，只做了最小的那一下', 3, ''],
    [4, 4, 3, 4, 2, false, 2, false, null, '', null, ''],
    [5, 4, 4, 3, 2, true,  2, true,  3, '把手机放客厅这件事，找到位置了', 5, ''],
    [6, 3, 3, 2, 1, true,  1, true,  2, '写完了那句没骂出口的话，写的时候很烦', 4, '']
  ];
